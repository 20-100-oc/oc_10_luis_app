...
class MainDialog(ComponentDialog):
    ...
    async def final_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        if step_context.result is not None:
            ...
            #TODO maybe don't keep this dialogue because we ask for confirmation before
            #msg_txt = f"To sum up:\ngo to {result.dst_city} from {result.or_city}\n({result.str_date} to {result.end_date}) with budget of {result.budget}"
            msg_txt = 'Booking details confirmed.'
